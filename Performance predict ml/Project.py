...
while(ch != 10):
    ...
    if (ch == 1):
        ...
        print("Loading Graph..\n")
        t.sleep(1)
        print("\tMarks Class District-wise Graph")
        fig, axesarr = plt.subplots(1, figsize=(10, 6))
        sb.countplot(x='District', hue='Class', data=data, hue_order=['L', 'M', 'H'], axes=axesarr)
        plt.show()
    elif (ch == 5):
        print("Loading Graph: \n")
        t.sleep(1)
